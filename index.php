  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <h1 class="text-white">Kota Depok</h1>
        <p class="text-white">
          Sistem informasi ini merupakan aplikasi pemetaan geografis tempat ngopi di wilayah kota Depok. Aplikasi ini memuat informasi dan lokasi dari tempat ngopi di kota Depok.
        </p>
    ...
    <section id="peta_wisata" class="about-info-area section-gap">
      <div class="container">
        ...
        <div class="title text-center">
          <h1 class="mb-10">Peta Lokasi Cafe</h1>
          <br>
        </div>
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Aplikasi pemetaan geografis Wisata di Kota Depok ini memuat informasi dan lokasi dari cafe yang tersedia di Depok. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
          </div>
        </div>
      </div>
